...
class Carta:
    def __init__(self):
        ...
        self.posicon = 0
        self.oculto = True
        self.foto = PhotoImage(file="./images/background/card/fondo.gif")
...
class Memorama:
    ...
    def __init__(self):
        ...
        self.par = 0
        self.listo = True
        self.fondo = PhotoImage(file="./images/background/card/fondo.gif")
        self.crearTablero()
        self.revolver()
    ...
    def crearTablero(self):
        ...
        while i<4:
            j = 0
            while j<4:
                btn = Button(self.ventana, command=lambda a = contador: self.revisar(a),
    ...
    def revolver(self):
        ...
        while(i<=8):
            carta1 = Carta()
            carta1.valor = i
            carta1.foto = PhotoImage(file="./images/animals/animal/"+str(i)+".gif")
            carta2 = Carta()
            carta2.valor = i
            carta2.foto = PhotoImage(file="./images/animals/letterAnimal/"+str(i)+".gif")
